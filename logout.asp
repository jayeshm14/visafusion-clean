            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <table width="100%" border="0">
                    <tr> 
                      ...
                      <td width="99%" height="46"><span class="WSRightBold"> 
                        <div align="justify"><span class="WSRightBold"><marquee><font face="Verdana" size="2">Welcome 
              ...
              <tr bgcolor="#FFFFFF"> 
                <td width="100%" colspan="2"> 
                  <div align="left"><marquee><font face="Verdana" size="3"></font></marquee></div>
                </td>
              </tr>
            </table>
          </td>
