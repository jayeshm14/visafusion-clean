...
invoiceno.open "select max(invoiceno) from invoice where invtype='B'",con
...
InsuranceRemart=rsmain.fields("Agentinstruction")
...
<table width="658" border="0" align="center">
  <tr > 
    <td colspan="7" >
<% if payment<>"" then %><img src="images/alert1.gif" width="40" height="20"> 
      Payment Condition is : <font color="#FF0000"><b><%=payment%>&nbsp;</b></font><% end if %>

<% if InsuranceRemart<>"" then %><br><img src="images/alert1.gif" width="40" height="20"> 
      Insurance Remark : <font color="#FF0000"><b><%=InsuranceRemart%>&nbsp;</b></font><% end if %>
</td>
  </tr>
  <tr bgcolor="#CCCCCC" bordercolor="#FFFFFF" > 
    ...
    <td width="53" > 
      <div align="left"><font color="#000000"><b>VFS/TT</b></font></div>
    </td>
    <td width="50" > 
...
stmt ="select Entrydetails.Totalpax,paxstatus.paxid, paxstatus.total,paxstatus.refno, paxstatus.visafee,paxstatus.VFSTTCharges,paxstatus.handlingfee,paxstatus.ddcharges,paxstatus.colcheck, paxstatus.paxID,EntryDetails.paxname,paxstatus.countryID,paxstatus.statusID,paxstatus.sentdate,entryDetails.Paxname, Mainentry.Agent from Mainentry,EntryDetails,Paxstatus where paxstatus.paxid=entrydetails.paxid and entrydetails.refno=mainentry.refno and Mainentry.refno="&refno&"   order by entryDetails.Paxname"
rs.open stmt,con
...
total_handling = total_handling + temp_handlingfee
...
%> 
  ...
  <%
			...
			%> 
  <tr bgcolor="#ffffFF"> 
    <td colspan="7" align="center" > <%=ucase(rs1.fields("name"))%> Book <%=ucase(rs1.fields("vehical"))%> 
...
%> 
  ...
  <%
			...
			%> 
  <tr bgcolor="#ffffFF"> 
    <td colspan="7" align="center"> <%=ucase(rs1.fields("name"))%> Book <% call writeIDDescription("hotel",ucase(rs1.fields("hotelname"))) %> 
...
<%
dim service_charge
service_charge= total_handling * 12.36
service_charge=service_charge/100
%>
      <div align="right">Misc. Charges 1: 
        <input type="text" name="miscremark"  size="50" value="Service tax 12.36% on Handling charges" >
      </div>
    </td>
    <td width="66" > 
      <input type='text' name='misc' size='10' onchange ="add2Total()" value="<%=service_charge%>">
    </td>
  ...
  <tr bgcolor="#ffffFF" bordercolor="#FFFFFF"> 
    <td colspan="7" height="20" > 
      <div align="right">Misc. Charges 2: 
        <input type="text" name="attestremark"  size="50" value="<%=InsuranceRemart%>" >
      </div>
    </td>
    <td width="66" > 
...
<table width="658" border="0" align="center">
  ...
  <tr width="300"> 
    <td align="right" colspan=3> <b>Authorised Signatory.</b> </td>
  </tr>
  <tr> 
    <td align="center"> 
...
<script language="javascript">
				...
				if (parseInt(z)==1)
				{
				  ...
				  var VFSTT=parseFloat(eval("document.regist.VFSTTCharges.value"));
				  if (isNaN(VFSTT)) 
				  {
				  VFSTT=0;
				  }				
				  ...
				  handling=0;
					...
					{
						servicetax=handling*12.36
						servicetax=servicetax/100
						document.regist.misc.value=Math.round(servicetax)
					}
				  ...
				  document.regist.total.value= eval(visa+VFSTT+handling+dd);
				...
				for (i=0;i<z;i++)
				{
				  ...
				  var VFSTT=parseFloat(eval("document.regist.VFSTTCharges("+i+").value"));
				  if (isNaN(visa)) 
				  {
				  VFSTT=0;
				  }
				...
				{
				tothandling=tothandling+handling
				var servicetax=tothandling*12.36
				servicetax=servicetax/100
				document.regist.misc.value=Math.round(servicetax)
				}
				  ...
				  document.regist.total(i).value= eval(visa+VFSTT+handling+dd);
