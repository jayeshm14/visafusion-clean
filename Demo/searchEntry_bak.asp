              ...
              <tr> 
                ...
                <td bgcolor="#FFFFFF"> 
                  <table width="100%" border="0" bgcolor="#FFFFF8" cellpadding="0" cellspacing="0" background="images/backform.jpg">
                   ...
                   <tr>
                   <td align="center"> 
<form name=collection1 action="searchPax.asp" method="post" onSubmit="return check()">
                   ...
                   <td align="center"> 
<form name=collection3 action="searchPax.asp" method="post">
              ...
              %> 
                    ...
                    <tr> 
                      <td align="center"> 
<form name="regist" action="searchPax.asp" method="post">
