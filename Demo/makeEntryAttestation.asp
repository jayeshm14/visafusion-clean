        ...
        <tr>
          ...
          <td width="85%" valign="top"> 
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <form  action="insertEntryAttestation.asp" method=post>
...
%> 
                                          ...
                                          <tr> 
                                            ...
                                            <td width="20%" bgcolor="#F0F0FF"><font size="2" color="#0000CC" face="Arial, Helvetica, sans-serif"><b>Passport 
                                              No </b></font></td>
                                            <td width="2%" bgcolor="#F0F0FF"><font size="2" color="#0000CC" face="Arial, Helvetica, sans-serif"><b>:</b></font></td>
                                            <td width="27%"> <font size="2" color="#006600" face="Arial, Helvetica, sans-serif"><%=passport %> 
                                              <input type="hidden" name="passport" value="<%=passport %>" >
                                              </font></td>
                                          </tr>
                                          <tr> 
                                            <td width="26%" bgcolor="#F0F0FF"><font size="2" color="#0000CC" face="Arial, Helvetica, sans-serif"><b>Pessengers 
                                              </b></font></td>
                                            <td width="2%" bgcolor="#F0F0FF"><font size="2" color="#0000CC" face="Arial, Helvetica, sans-serif"><b>: 
                                              </b></font></td>
                                            <td width="23%"> <font size="2" color="#006600" face="Arial, Helvetica, sans-serif"><%= totalp %> 
                                              <input type="hidden" name="totalp" value=<%=totalp %> >
                                              </font></td>
                                            <td width="20%" bgcolor="#F0F0FF"><font size="2" color="#0000CC" face="Arial, Helvetica, sans-serif"><b>Entries 
                                              </b></font></td>
                                            <td width="2%" bgcolor="#F0F0FF"><font size="2" color="#0000CC" face="Arial, Helvetica, sans-serif"><b>: 
                                              </b></font></td>
                                            <td width="27%"> <font size="2" color="#006600" face="Arial, Helvetica, sans-serif"><%= entries %> 
                                              <input type="hidden" name="entries" value=<%=entries %> >
                                              </font></td>
                                          </tr>
                                          <tr> 
                                            <td width="26%" bgcolor="#F0F0FF"><font size="2" color="#0000CC" face="Arial, Helvetica, sans-serif"><b>Date 
                                              Of Birth </b></font></td>
                                            <td width="2%" bgcolor="#F0F0FF"><font size="2" color="#0000CC" face="Arial, Helvetica, sans-serif"><b>:</b></font></td>
                                            <td width="23%"> <font size="2" color="#006600" face="Arial, Helvetica, sans-serif"><%=dob%> 
					      ...
					      %> 
                                          ...
                                          <tr> 
                                            <td width="26%" bgcolor="#F0F0FF"><font size="2" color="#0000CC" face="Arial, Helvetica, sans-serif"><b>Submit 
                                              Date </b></font></td>
                                            <td width="2%" bgcolor="#F0F0FF"><font size="2" color="#0000CC" face="Arial, Helvetica, sans-serif"><b>:</b></font></td>
                                            <td width="23%"> <font size="2" color="#006600" face="Arial, Helvetica, sans-serif">
                                            <%
                                            If subdate <> "" Then
                                             Response.write ucase(FormatDateTime(subdate,1)) 
                                            End if
                                            %> 
                                              <input type="hidden" name="subdate" value="<%=subdate %>" >
                                              </font></td>
                                            <td width="20%" bgcolor="#F0F0FF"><font size="2" color="#0000CC" face="Arial, Helvetica, sans-serif"><b>Collection 
                                              Date </b></font></td>
                                            <td width="2%" bgcolor="#F0F0FF"><font size="2" color="#0000CC" face="Arial, Helvetica, sans-serif"><b>:</b></font></td>
                                            <td width="27%"> <font size="2" color="#006600" face="Arial, Helvetica, sans-serif">
                                            <% If coldate<>"" Then                                            	
                                            Response.write ucase(FormatDateTime(coldate,1))
                                            End if 
                                             %> 
                                          ...
                                          <tr> 
                                            <td width="26%" bgcolor="#F0F0FF"><font size="2" color="#0000CC" face="Arial, Helvetica, sans-serif"><b>Category 
                                              </b></font></td>
                                            <td width="2%" bgcolor="#F0F0FF"><font size="2" color="#0000CC" face="Arial, Helvetica, sans-serif"><b>: 
                                              </b></font></td>
                                            <td width="23%"> <font size="2" color="#006600" face="Arial, Helvetica, sans-serif">
                                            ...
                                            <td width="20%" bgcolor="#F0F0FF"><font size="2" color="#0000CC" face="Arial, Helvetica, sans-serif"><b>Attestation 
                                              </b></font></td>
                                            <td width="2%" bgcolor="#F0F0FF"><font size="2" color="#0000CC" face="Arial, Helvetica, sans-serif"><b>: 
                                              </b></font></td>
                                            <td width="27%"> <font size="2" color="#006600" face="Arial, Helvetica, sans-serif">
                                          ...
                                          <tr> 
                                            <td width="26%" bgcolor="#F0F0FF"><font size="2" color="#0000CC" face="Arial, Helvetica, sans-serif"><b>Entry 
                                              Type</b></font></td>
                                            <td width="2%" bgcolor="#F0F0FF"><font size="2" color="#0000CC" face="Arial, Helvetica, sans-serif"><b>:</b></font></td>
                                            <td width="23%"> <font size="2" color="#006600" face="Arial, Helvetica, sans-serif"><%
                                            if entrytype <> "" then
                                            call writeIDdescription("entrytype",entrytype)
                                            end if
                                             %> 
                                            ...
                                            <td width="20%"></td>
                                            <td width="2%"></td>
                                            <td width="27%"><font color="#006600"></font></td>
                                          </tr>
                                          <tr> 
                                            <td valign="top" width="26%" bgcolor="#F0F0FF"><font size="2" color="#0000CC" face="Arial, Helvetica, sans-serif"><b>Selected 
                                              Country (s)</b></font></td>
                                            <td valign="top" width="2%" bgcolor="#F0F0FF"><font size="2" color="#0000CC" face="Arial, Helvetica, sans-serif"><b>:</b></font></td>
...
return false;
	...
	response.write "<td colspan=6 valign=top ><font size=2 color=#0000CC><b>"

for ii=1 to count
		response.write "<input type=hidden name=country"&ii &" value='"& request.form("countrylist")(ii)&"' ><font size=2 color='#006600'>"
		if request.form("countrylist")(ii)<> "" then
		countrylist(cnt)= Request.Form("countrylist")(ii)
		varCountry=request.form("countrylist")(ii)
	...
	<%
	response.write "<TR><TD><input type=text name='name1' value="& "'"& ucase(pname) &"'"&"size=15 > </TD><TD> <input type=text name='epassport1' value="&"'"&passport&"'"& "size=10></TD><TD> <input type=text name='totp1'  value='1' size=4></TD><TD><input type=text name=dob1 value='"&request("dob")&"' size=10></TD></tr>"
	...
	certcount=0
certcount=request.form("certificate").count

for mii=1 to certcount
if request.form("certificate")(mii)<> "" then
	
certName=getDescriptionForID("certificate",Request.Form("certificate")(mii))
response.write "<input type=checkbox name='CertificateID1"&l&mii&"' value="&Request.Form("certificate")(mii)&" checked>"&certName&"<br>"
response.write "<select name=AttestationID1"&l&mii&" size=""1"">"
	  Call LoadListBox("attestation",request("attestation"))
                                          
	response.write "</SELECT><br>"
cntcert=cntcert+1
end if
next           
	response.write "</td><TD COLSPAN=2><font size=""1"" color=""#006600"" face=""Arial, Helvetica, sans-serif"">SUB:<input type=text name=subdate1"&l&" size='10' value="&request("subdate")&"  > <br> COL:<input type=text name=coldate1"&l&" size='10' value="&request("coldate")&" >"
	...
	for k=2 to entries
	response.write "<TR><TD><input type=text name=name"&k&" size=15 ></TD><TD> <input type=text name=epassport"&k&"   size=10></TD><TD><input type=text name=totp"&k&"  value=1 size=4> </TD><TD><input type=text name=dob"&k&"   size='10'></TD></tr>"
...
for mii=1 to certcount
if request.form("certificate")(mii)<> "" then
'certlist(cntcert)= Request.Form("certificate")(mii)
certName=getDescriptionForID("certificate",Request.Form("certificate")(mii))
response.write "<input type=checkbox name='CertificateID"&k&l&mii&"' value="&Request.Form("certificate")(mii)&" checked>"&certName&"<br>"
response.write "<select name=AttestationID"&k&l&" size=""1"">"
	  Call LoadListBox("attestation",request("attestation"))
...
next    
	response.write "</td><TD COLSPAN=2><font size=""1"" color=""#006600"" face=""Arial, Helvetica, sans-serif"">SUB:<input type=text name=subdate"&k&l&" size='10' value="&request("subdate")&"  ><br>COL:<input type=text name=coldate"&k&l&" size='10' value="&request("coldate")&" >"
...
response.write "<input type=hidden name=venesh value="&count&" >"
response.write "<input type=hidden name=certcount value="&certcount&" ></b></font> </td></TR>"
...
%> 
                                          ...
                                          <tr> 
                                            <td width="26%" bgcolor="#F0F0FF"><font size="2" color="#0000CC" face="Arial, Helvetica, sans-serif"><b>Client's 
                                              Message </b></font></td>
                                            <td width="2%" bgcolor="#F0F0FF"><font size="2" color="#0000CC" face="Arial, Helvetica, sans-serif"><b>:</b></font></td>
