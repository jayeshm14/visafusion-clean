    ...
    <td height="20"> <%
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFE898">
        <tr>
          ...
          <td>
            <div align="left"><span class="barfont"><a href="Agent.asp?statustype=sub&logon=Y&anp=34&cd=2345&seckey=xyz25g78md20422npr054416panftphjkslsktls&ses=k3456l7dj9javyemsn&company=udaan&jn=<%=agentID%>" class="udtop">Submitted</a>&nbsp;| 
              <a href="Agent.asp?statustype=col&logon=Y&anp=34&cd=2345&seckey=xyz25g78md20422npr054416panftphjkslsktls&ses=k3456l7dj9javyemsn&company=udaan&jn=<%=agentID%>" class="udtop" > 
              Collected&nbsp;</a>| <a href="Agent.asp?statustype=pen&logon=Y&anp=34&cd=2345&seckey=xyz25g78md20422npr054416panftphjkslsktls&ses=k3456l7dj9javyemsn&company=udaan&jn=<%=agentID%>" class="udtop" >Pending</a>&nbsp;| 
              <a href="Agent.asp?statustype=sen&logon=Y&anp=34&cd=2345&seckey=xyz25g78md20422npr054416panftphjkslsktls&ses=k3456l7dj9javyemsn&company=udaan&jn=<%=agentID%>" class="udtop">Sent</a>&nbsp;| 
              ...
              |<a href="visainfo.asp?agentusb=yesuma&amp;logon=Y&amp;anp=34&amp;cd=2345&amp;seckey=xyz25g78md20422npr054416panftphjkslsktls&amp;ses=k3456l7dj9javyemsn&amp;company=udaan&amp;jn=<%=agentID%>"> 
              Visa Information </a> &nbsp;| <a href="forms.asp?agentusb=yesuma&amp;logon=Y&amp;anp=34&amp;cd=2345&amp;seckey=xyz25g78md20422npr054416panftphjkslsktls&amp;ses=k3456l7dj9javyemsn&amp;company=udaan&amp;jn=<%=agentID%>"> 
              Visa Forms</a> | <a href="changepasswordforagent.asp?uname=<%=session("uname")%>&&logon=Y&anp=34&cd=2345&seckey=xyz25g78md20422npr054416panftphjkslsktls&ses=k3456l7dj9javyemsn&company=udaan&jn=<%=agentID%>" class="udtop">Change 
              Password</a>&nbsp;| <a href="editbyagent.asp?uname=<%=session("uname")%>&&logon=Y&anp=34&cd=2345&seckey=xyz25g78md20422npr054416panftphjkslsktls&ses=k3456l7dj9javyemsn&company=udaan&jn=<%=agentID%>" class="udtop">Edit 
              Your Info</a>&nbsp;| <a href="javascript:print()"> Print</a>&nbsp;| 
              <a href="javascript:UdaanChat()"> Chat Online </a> </span></div>
          </td>
 ...
 <input type="hidden" name="jn" value="<%=request("jn")%>">
      <table width="100%" border="0" cellspacing="1" cellpadding="1">
        <tr>
          ...
          <td>
            <input type="text" name="keywords" onFocus="this.value=''" value="  - TYPE PAX NAME -  ">
          </td>
          <td>
