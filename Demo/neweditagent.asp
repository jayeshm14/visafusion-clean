          ...
          <td> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td bgcolor="#FFFFFF"> 
<FORM action="neweditdoneagent1.asp"  method=post name=agentform onsubmit="return checkAll()">
                              <table width="100%" border="0" bgcolor="#FFFFF8" cellpadding="0" cellspacing="0" background="images/backform.jpg">
                                <tr> 
                                  <td> <%
                agent=request("agent")
set rs=server.createobject("adodb.recordset")
stmt="select * from newagents where newagentsID="&cint(agent)
...
<% end if %>
                                  ...
                                  <TR> 
                                    <TD>&nbsp;&nbsp;&nbsp;<FONT color=red face="">STREET-1 
                                      </FONT></TD>
                                    <TD> 
                                  ...
                                  <TR> 
                                    <TD>&nbsp;&nbsp;&nbsp;<FONT color=red face="">DIRECTOR 
                                      NAME </FONT></TD>
                                    <TD><FONT color=red face=""> 
