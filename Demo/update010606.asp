                                  ...
                                  <td width="62%" height="286"> 
                                    <div align="justify"> 
                                      <table width="100%" border="0">
                                        ...
                                        <tr> 
                                          <td height="45"> 
                                            <div align="center"><img src="updateimg/date%20010606.png" width="280" height="62"></div>
                                          </td>
                                        </tr>
                                      </table>
                                      <div align="justify"> 
                                        <table width="659" border="0">
                                          <tr>
                                            <td>
                                              <div align="center"> <font face="Verdana" size="3"><b>Malaysian 
                                                High Commission.... </b></font></div>
                                            </td>
                                          </tr>
                                        </table>
                                        <br>
                                        <p><font face="Verdana" size="2"><b>With 
                                          immediate effect, all manual applications 
                                          should be filled in original visa application 
                                          forms. These forms are available at 
                                          a cost of <font color="#FF0033">Rs. 
                                          15/-</font> per form.</b></font></p>
                                        <p><b><font face="Verdana" size="2">Kindly 
                                          follow the above instruction to avoid 
                                          delay in processing of visa.<br>
                                          <br>
                                          Note :- However you can download the 
                                          original visa form on the Malaysian 
                                          embassy website - <a href="http://www.imi.gov.my">http://www.imi.gov.my<br>
