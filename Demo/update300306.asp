        ...
        <tr> 
          <td> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td width="21" height="159">&nbsp;</td>
                <td colspan="3" height="159"> 
                  <table height="1" cellspacing="0" cellpadding="0" width="100%" border="0">
                    <tbody> 
                    <tr> 
                      <td colspan="2" height="550"> 
                        <table width="617" align="center" height="250" border="1" bordercolor="#333333">
                          <tr> 
                          ...
                          <tr valign="top" > 
                            <td height="165" colspan="2"> 
                              <table width="98%" border="1" height="136">
                                <tr bordercolor="#000000" valign="top"> 
                                  <td width="62%" height="146"> 
                                    <div align="justify"> 
                                      <table width="100%" border="0">
                                        <tr> 
                                          <td> 
                                            <div align="center"><img src="http://www.udaanindia.com/updateimg/Malaysia%20Heading160306.png" width="305" height="58"></div>
                                          </td>
                                        </tr>
                                      </table>
                                      <div align="justify"> 
                                        <p>&nbsp;</p>
                                        <p><b><font face="Verdana">Latest update 
                                          from South Africa High Commission on 
                                          Visa processing and withdrawal of passports 
                                          <a href="http://www.udaanindia.com/south%20africa%20update.doc" target="_blank">(kindly 
                                          click here)</a><font size="3"><font size="2"> 
                                          </font></font></font></b></p>
