  ...
  <tr> 
    <td> 
      <table width="75%" align="center" cellpadding="0" cellspacing="0">
        <tr bgcolor=> 
          <td height="19"> 
            <div align="center"><span class="tableCaption"><img src="updateimg/Agent Information.jpg" width="300" height="69"></span><font size="2"><a href="newagenthome.asp?uname=<%=session("uname")%>">New</a></font></div>
          </td>
        </tr>
      </table>
    </td>
                    ...
                    <tr> 
                      <td colspan="3"> 
                        <div align="center"><span class="WebSite"> 
                          ...
                          <input type="submit"  class="ud" name="submit" value="Send AWB" >
<% if session("priv")="adm" then %>
