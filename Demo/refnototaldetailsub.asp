    ...
    <td height="821"> 
      <table width="94%" border="0" cellpadding="0" cellspacing="0" align="center">
        <tr valign="middle" align="center"> 
          <td> 
            <p><font color="#000000" face="" size="5"><b> <font size="7"><% if agentid = 1359 then %><%=VisaSName%><%else%><%=udaanName%><%end if%></font></b></font></p>
          </td>
        </tr>
        <tr> 
          <td  align="center"><font size="3" color="#000000" face="Arial, Helvetica, sans-serif"><% if agentid = 1359 then %><%=VisaSAddress%><%else%><%=udaanAddress%><%end if%> 
            </font></td>
        </tr>
        <tr> 
          <td align="center"><font face="Arial, Helvetica, sans-serif" size="3" color="#000000"> 
            <% if agentid = 1359 then %><%=VisaSContact%><%else%><%=Contactaccounts%><%end if%></font></td>
        </tr>
      </table>
            ...
            <td colspan="3" height="628"> 
              <table width="658" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" height="58">
                ...
                <tr > 
                  ...
                  <td width="80" bgcolor="#CCCCCC" > 
                    <div align="center"><font color="#000000" size="4"><b>VFS/Others 
                      </b></font></div>
                  </td>
                  <td width="80" bgcolor="#CCCCCC" > 
...
call writeIDDescription("embassy", rs("countryID"))
	%>&nbsp;</b></font></div>
                  ...
                  <td bgcolor="#FFFFFF" width="80" height="5" > 
                    <div align="center"><font color="#000000"><b><font size="6"><%=temp_VFSTTCharges%> 
                      </font></b></font></div>
                  </td>
                  <td bgcolor="#FFFFFF" width="80" height="5" > 
...
%> 
                ...
                <tr> 
                  <td colspan="10" bordercolor="#999999" bgcolor="#ffffFF" > 
                    <hr width="65" align="right" noshade size="2">
                  </td>
                </tr>
                <tr> 
                  <td colspan="7" bordercolor="#999999" bgcolor="#ffffFF" > 
                ...
                <tr valign="top"> 
                  <td colspan="10" bordercolor="#999999" height="133" bgcolor="#ffffFF" > 
                    <p><b><font size="4">E. & O. E.</font></b><br>
                      <font face="Arial, Helvetica, sans-serif" size="3">1. &nbsp;No 
                      dispute or objection will be entertained if not brought 
                      to our notice within 7 days from the date <br>
                      ...
                      in favour of <% if agentid = 1359 then %>VISA SOLUTIONS 
                      <%else%>UDAAN INDIA (P) LTD.<%end if%><br>
