...
EmailBody=EmailBody& "We encourage you to kindly   change the password given to your office. The new password generated should   be of minimum eight characters (alpha / numeric) related to your company name.   </font></p><p><font face='Arial, Helvetica, sans-serif' size='2'>For any technical queries   about the Website, mail to: pankaj@udaanindia.com <br>  Pankaj Sharma <br>  (Manager - IT) </font></p></body></html>"
