...
refno=request("refno")
if refno<>""  then
'This if has end if at the end of the file
...
EmailBody=EmailBody& "<table width=100% border=0 cellspacing=1 cellpadding=1 align=""center"">"
...
EmailBody=EmailBody& "<tr><td VALIGN=""TOP"" colspan=""8"" ><BR><font size=""3""><b>MESSAGE FOR AGENT : </b>"& ucase(externalRemark)& "</font></td></tr>"
end if
EmailBody=EmailBody& "<tr><td colspan=""8""><br><font size=""2"" color=""#000000""><b>Regards,<br>"&Session("lname")&"</b></font></td></tr>"
...
EmailBody=EmailBody& "</tr><tr><td colspan=""8"" size=""50""> <font size=""2"" color=""#000000""><b>"&  todaysupdate(today)& "</b></font>"
EmailBody=EmailBody& "</td></tr>"
                 End If

EmailBody=EmailBody& "<tr><td colspan=""8""><br><font size=""3"" color=""#000000""><b>Holiday list for next 30 days.<!--"& MonthName(month(today))&", " & year(today)&"--> </b></font></td>"
...
EmailBody=EmailBody& "<tr> <td colspan=""8"">&nbsp;</td></tr>"

EmailBody=EmailBody& "<tr> <td colspan=""8""><font size=""3"" color=""#000000""><b>For Latest Information Log on to our web site <a href=""http://www.udaanindia.com"" target=""_blank"">www.udaanindia.com</a></b></font></td></tr></table>"
...
response.Write "This agent does not have any email ID. Please get email ID for faster communication."
End if
end if
rsAgentEmail.close()

emailSubject= "RECEIPT FOR REF.# "&request("refno")&" - "& emailpaxName & " on "&formatdateTime(today,1)
if request("paxID")<>"" and request("country")<>"" then
emailSubject= "STATUS FOR "&emailpaxName&"("&countryname&")"

end if
IF request("sentEmail")="Y" THEN
emailSubject= "Visa Status Update FOR REF.# "&request("refno")&" - "& emailpaxName & " on "&formatdateTime(today,1)
END IF
...
Response.write "Email has been sent to the agent at following email ID(s): <b> "&agentEmail&"</b>"
End if
