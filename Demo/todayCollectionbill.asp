        ...
        <table width="75%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000090">
          <tr bgcolor="#FFFFF0"> 
            <td height="19"> 
              ...
              TODAY's COLLECTIONS BILL HAS NOT FORMED</font></font></b></div>
            </td>
          </tr>
        </table>
      </td>
...
stmt ="select Entrydetails.Totalpax, paxstatus.refno,paxstatus.colcheck,paxstatus.paxID,MainEntry.internalRemark,MainEntry.poe,MainEntry.agentInstruction,EntryDetails.paxname,paxstatus.coldate,paxstatus.Subdate, paxstatus.countryID,paxstatus.statusID,paxstatus.remarks,paxstatus.sentdate,entryDetails.Paxname,MainEntry.receivedate, Mainentry.Agent from Mainentry,EntryDetails,Paxstatus where day(paxstatus.coldate)="&day(today)&" and Month(paxstatus.coldate)="&Month(today)&" and year(paxstatus.coldate)="&year(today)&" and paxstatus.paxid=entrydetails.paxid and entrydetails.refno=mainentry.refno and mainentry.bill='N' order by mainEntry.refno"
...
if i=cint(pageno) then
    	...
    	response.write "&nbsp;<a href='todaycollectionbill.asp?page="&i&"'>"&i &"</a>&nbsp;"
    end if
 next
end if 
...
If PageNo > 1 then
	response.write "<form method='post' action='todaycollectionbill.asp'>"
