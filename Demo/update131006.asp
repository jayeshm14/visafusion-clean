...
<table width="652" border="1">
                                        ...
                                        <p align="justify"><font face="Verdana" size="3"><font size="2">Dear 
                                          ...
                                          support and help. <br>
                                          <br>
                                          If you are not registered with Udaan 
                                          or are facing any kind of problem with 
                                          your <b>User id and Password,</b> Please 
                                          mail <a href="mailto:pankaj@udaanindia.com"><b>Pankaj 
                                          Sharma</b></a><br>
                                          <br>
                                          We have also noticed that a lot of mails 
                                          bounce back when we send an UPDATE, 
                                          we would appreciate if you could logon 
                                          to your account and cross check your 
                                          details. <br>
                                          <br>
                                          <br>
                                          <b>Regards</b><br>
