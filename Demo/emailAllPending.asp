...
rsPending.open "select * from mainEntry where status='Pending'",con
...
objNewEmail.to= "rajvenesh.p@igiindia.com"
objNewEmail.subject=emailSubject
objNewEmail.body= emailBody
'objNewEmail.send
Set objNewEmail = Nothing
End if
Response.write "<br><B>Refrence number:"&refno &" Agent's Email: "&agentEmail &"</B><br>"
