...
stmt="select a.refno, a.paxname, a.agent, a.refferer, a.companyname, a.passportno, a.totalpassengers, a.entries, a.dateofbirth, a.subdate, a.coldate, a.receivedate, a.sentDate, a.entrytype, a.category, a.attestation, a.poe, a.status, a.externalremark, a.internalremark, a.AgentInstruction, a.entrydatetime from Mainentry a, paxstatus b where day(b.sentdate) = "&day(SentDate)&" and month(b.sentdate)="&month(SentDate)&" and year(b.sentdate)="&year(SentDate)&" and a.refno = b.refno order by a.refno"
...
<table width="475" border="1" align="center">
  <tr bgcolor="#CCCCFF"> 
    <td width="30"><font size="2" face="Arial, Helvetica, sans-serif" color="#3300CC"><b><font color="#000000">Ref 
      #</font></b></font></td>
...
%> 
  <tr bgcolor="#F0F0FF" valign="top"> 
    <td width="30"><font face="arial" size="2" color="#000000"><%=refno%></font></td>
