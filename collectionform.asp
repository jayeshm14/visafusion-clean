...
%> 
              ...
              %>
                ...
                <input type="hidden" name="pname" value="<%= pname%>" >
                  <td colspan="2"><font size="2" face="verdana" color="#0000CC"><b>Date: <% response.write(formatdatetime(now(),1))%></b></font></td>
                  <td colspan="2"><font size="2" face="verdana" color="#0000CC"><b>Refrence Number: 
                    <%= refno %> 
                ...
                <tr> 
                  <td width="21%"><font size="2" face="verdana" color="#0000CC"><b>Agent</b></font></td>
                  <td width="19%"> <font size="2" face="verdana" color="#006600"><b>
                  ...
                  %> 
                    ...
                    <td width="25%"><font size="2" face="verdana" color="#0000CC"><b>Receive date 
                    </b></font></td>
                  <td width="19%"> <font size="2" face="verdana" color="#006600"><b><%=recdate%> </b></font></td>
                </tr>
                    
                    
                <tr> 
                  <td width="21%"><font size="2" face="verdana" color="#0000CC"><b>Referer</b></font></td>
                  <td width="30%"> <font size="2" face="verdana" color="#006600"><b><%= refname %> 
                    
                    </b></font></td>
                  <td width="25%"><font size="2" face="verdana" color="#0000CC"><b>Company</b></font></td>
                  <td width="19%"> <font size="2" face="verdana" color="#006600"><b><%=company %> 
                    
                    </b></font></td>
                <tr> 
                  <td width="21%"><font size="2" face="verdana" color="#0000CC"><b>PAX Name</b></font></td>
                  <td width="30%"> <font size="2" face="verdana" color="#006600"><b><%= pname %> 
                    
                    </b></font></td>
                    <td width="25%"><font size="2" face="verdana" color="#0000CC"><b>Entries </b></font></td>
                  <td width="19%"> <font size="2" face="verdana" color="#006600"><b><%= entries %> 
                ...
                <tr> 
                  <td width="21%"><font size="2" face="verdana" color="#0000CC"><b>Category </b></font></td>
                ...
                -->
                <tr> 
                  <td width="21%"><font size="2" face="verdana" color="#0000CC"><b>POE/ECNR </b></font></td>
                  <td width="30%"> <font size="2" face="verdana" color="#006600"><b>
                  <%
                  ...
                  <td width="25%"><font size="2" face="verdana" color="#0000CC"><b>Status</b></font></td>
                  <td width="19%"><font size="2" face="verdana" color="#006600"><b>
                  <%
                ...
                <tr> 
                  <td width="21%"><font size="2" face="verdana" color="#0000CC"><b>Country(s)</b></font></td>
                  <td width="30%"><font size="2" face="verdana" color="#006600"><b>
                <%
		...
		%>
                ...
                <tr> 
                  <td width="21%" height="21"><font size="2" face="verdana" color="#0000CC"><b>Status</b></font></td>
...
<!--
                 <td width="25%"><font size="2" face="verdana" color="#0000CC"><b>Sent Date</b></font></td>
                  <td width="19%"> <font size="2" face="verdana" color="#006600"><b><input type="text" name="sentdate" value="" size="10" >
                  </font><font size="2" face="verdana"><a href="javascript:getDate(regist.sentdate)"><img src="images/cal.jpg" border=0  align="absmiddle"></a> 
                  </font>
...
%>
		<tr> 
    		...
    		<tr> 
                  <td colspan="4"> 
                    <div align="left"><font size="2" face="verdana" color="#0000CC"><b>Please 
                      Enter the information regarding <font size="3" face="verdana" color="#006600"><b> <%= ucase(pname1) %></b></font> for country 
                     <%  
			...
			End if
                      ...
                      %>
                <tr> 
                <td ><font size="2" face="verdana" color="#0000CC"><b> Charges</b></font></td>
                  <td width="30%" colspan=3> 
<% if ucase(session("uname"))="UMA" or ucase(session("uname"))="VIPIN" or ucase(session("uname"))="BINEET" or ucase(session("uname"))="MANISH" or ucase(session("uname"))="HKSHAH" or ucase(session("uname"))="AKHIL" then %>
                    <Table border="1"><tr>
...
<% else %>                      
                  ...
                  <td > <font size="2" face="verdana" color="#006600"><b> Visa</b></font></td>
                    ...
                    <tr>
                  <td > <font size="2" color="#006600"><b> 
                  <input type="text" name="visafee<%=i%>" value="<%=temp_visafee%>" size="8" onblur="add2Total<%=i%>()" maxlength="20" readonly></b></font></td>
                    <td> <font size="2" color="#006600"><b>
                    <input type="text" name="dd<%=i%>" value="<%=temp_ddcharges%>" size="8"    onblur="add2Total<%=i%>()" maxlength="20" readonly>
                    </b></font></td>
                    <td > <font size="2" color="#006600"><b>
                    <input type="text" name="handling<%=i%>" value="<%=temp_handlingfee%>" size="8" onblur="add2Total<%=i%>()" maxlength="20" readonly>
                    </b></font></td>
                    <td > <font size="2" color="#006600"><b>
                    <input type="text" name="VFSTTCharges<%=i%>" value="<%=temp_VFSTTCharges%>" size="8" onblur="add2Total<%=i%>()" maxlength="20" readonly>
                    </b></font></td>
                    <td> <font size="2" color="#006600"><b>
                    <input type="text" name="total<%=i%>" value="<%=temp_total%>" size="10" maxlength="20" readonly>
                    <input type="hidden" name="oldtotal<%=i%>" value="<%=temp_total%>" >
...
%> 
                    ...
                    <td><font size="2" face="verdana" color="#0000CC"><b>Submit Date </b></font></td>
                    <td>
                ...
                <td><font size="2" face="verdana" color="#0000CC"><b>Sent date </b></font></td>
                    <td> <font size="2" face="verdana" color="#006600"><b>
                    ...
                    <tr> 
                       ...
                       if not categoryid=category then
                       %>
                       <td width="20%"><font size="2" face="verdana" color="#0000CC"><b>Category</b></font></td>
...
%>
                ...
                <tr> 
                  ...
                  <td width="80%" colspan=3> <font size="2" face="verdana" color="#006600"><b> 
 ...
 %>               
               ...
               <tr> 
                ...
                <td colspan="4"> 
                  ...
                  %>
                  <td colspan="2"> 
                    <div align="right"> <font size="2" face="verdana" color="#0000CC"><b> 
...
<% end if %>
                  ...
                  <td colspan="2"> <font size="2" face="verdana" color="#0000CC"><b> 
