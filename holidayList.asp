                          ...
                          <tr bgcolor="#FFE898"> 
                            <td height="19"> 
                              <div align="center"><b><font size="3" color="#CC0000" face="Arial, Helvetica, sans-serif"><font color="#000099"></font></font>HOLIDAY 
                                ...
                                </font></font><%=monthName(month(date1))&", "&year(Date1)%><font size="3" color="#CC0000" face="Arial, Helvetica, sans-serif"><font color="#000099"> 
                                </font></font></b></div>
                            </td>
                          </tr>
                        </table>
...
if request("OrdByCtry")="yes" then
                  ...
                  while not  rs.eof
		             ...
		             response.write"</td><td nowrap>"& formatDateTime(rs("holiday"),1)
...
%> 
  ...
  >December 
                                              ...
                                              <span class="barfont">
                                              <a href="holidayList.asp?OrdByCtry=yes&selmonth=<%=request("selmonth")%>&jn=<%=request("jn")%>&selyear=<%=request("selyear")%>"> <font color='blue' font face='verdana' size='2'>ORDER BY COUNTRY</a>
											
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<a href="WeeklyOffList.asp"> WEEKLY OFF LIST </font></a>
