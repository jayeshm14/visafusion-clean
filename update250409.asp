...
.style43 {font-size: 16px; font-family: Arial, Helvetica, sans-serif; }
.style41 {color: #000000; font-family: Arial, Helvetica, sans-serif; }
                                  ...
                                  <td width="62%" height="346" bordercolor="#000000"> 
                                    <div align="justify"> 
                                      ...
                                      <div align="justify"> <b>= = = = = = = = 
                                        ...
                                        <p align="justify" class='style27'>Dear Travel Agents,</p>
                                        <p align="justify"><span class="style43">With effect from 27th April' 09 all <strong>VFS - SCHENGEN CENTER</strong> have increased their processing fees as Rs 607/- per pax.</span><br>
                                          <br>
                                        </p>
                                        <p><span class="style27">LIST OF SCHENGEN COUNTRIES WHICH COMES UNDER VFS : </span><span class="style45"><br>
                                            </span><br>
                                        </p>
                                        <table width="217" border="0" bgcolor="#FFFFFF">
                                          <tr>
                                            <td class="style43"><p class="style41">Austria</p></td>
                                          </tr>
                                          <tr>
                                            <td class="style43"><p class="style41">Belgium</p></td>
                                          </tr>
                                          <tr>
                                            <td class="style43"><p class="style41">Denmark</p></td>
                                          </tr>
                                          <tr>
                                            <td bgcolor="#FFFFFF" class="style43"><p class="style41">France</p></td>
                                          </tr>
                                          <tr>
                                            <td class="style43"><p class="style41">Greece</p></td>
                                          </tr>
                                          <tr>
                                            <td class="style43"><p class="style41">Germany</p></td>
                                          </tr>
                                          <tr>
                                            <td class="style43"><p class="style41">Italy</p></td>
                                          </tr>
                                          <tr>
                                            <td class="style43"><p class="style41">Netherlands</p></td>
                                          </tr>
                                          <tr>
                                            <td class="style43"><p class="style41">Portugal</p></td>
                                          </tr>
                                          <tr>
                                            <td class="style43"><p class="style41">Switzerland</p></td>
                                          </tr>
                                          <tr>
                                            <td class="style43"><p class="style41">Sweden</p></td>
                                          </tr>
                                        </table>
                                        <br>
