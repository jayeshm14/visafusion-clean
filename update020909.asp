                            ...
                            <td height="2" colspan="2"> 
                              <table width="99%" border="0" height="753">
                                <tr bordercolor="#000000" valign="top" bgcolor="#FFFFFF">
                                  <td height="117" colspan="2" bordercolor="#000000"><table width="93%" border="0">
                                    <tr>
                                ...
                                <tr bordercolor="#000000" valign="top" bgcolor="#FFFFFF">
                                  <td height="46" colspan="2" bordercolor="#000000"><span class="style70"><U>FROM THE DESK OF RAJAN DUA/ MANAGING DIRECTOR - UDAAN</U></span></td>
                                  </tr>
                                <tr bordercolor="#000000" valign="top" bgcolor="#FFFFFF">
                                  <td width="21%" height="186" bordercolor="#000000"><span class="style19"><img src="HTTP://www.udaanindia.com/updateimg/RAJANDUA.jpg" alt="rajan" width="122" height="159" border="2" /></span></td>
                                  <td width="79%" bordercolor="#000000"><span class="style45"><span class="style60">Dear Travel Partners;</span><br>
                                      <br>
                                      <span class="style50"><span class="style24"><span class="style46">We <span class="style48">are providing our respected Travel Partners services in connection with cargo. This is essentially an emergency service facilitating our Travel partners. Recently there has been a steep increase in the charges for cargo by both Jet Airways and Indian Airlines.</span></span></span></span></span></td>
                                </tr>
                                <tr bordercolor="#000000" valign="top" bgcolor="#FFFFFF"> 
                                  <td height="346" colspan="2" bordercolor="#000000"> 
                                    <div align="justify">
                                      <div align="left"><span class="style46">The service provided by us involves movement to and fro to the airport, booking/collection of articles and enhanced parking charges.At times, the documents have to be delivered directly from the airport to the client.<br>
                                          <br>
In view of the above we are constrained to enhance our connecting cargo charges to <strong>Rs. 1,000</strong> all inclusive and Pick-up cargo charges to <strong>Rs. 500</strong></span></div>
