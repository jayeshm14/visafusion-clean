...
<%
Set rs123 = con.execute("select distinct(description) from agents order by description")
%>
<OBJECT ID="ComboBox1" WIDTH=300 HEIGHT=24 CLASSID="CLSID:8BD21D30-EC42-11CE-9E0D-00AA006002F3">
...
ComboBox1.Additem "<%=rs123("description")%>"
                  </script>
<% 
rs123.MoveNext
Loop
