                                    ...
                                    <div align="justify"> 
                                      ...
                                      <div align="justify"> 
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
                                          <tr>
                                            <td width="100%">Dear Travel Agent,
                                            <p>
                                            <br>
                                            With immediate effect the MEXICAN 
                                            EMBASSY has introduced BIOMETRIC 
                                            SYSTEM. Applicants from New Delhi 
                                            will have to come personally for 
                                            submission of documents during which 
                                            they will be required to give Index 
                                            finger impressions. This implies 
                                            that all travelers will now have to 
                                            give finger print of left and right 
                                            index fingers and thumbs. <br>
                                            <br>
                                            Applicants residing outside Delhi 
                                            are not (as of now) required to come 
                                            personally but will now have to send 
                                            an extra document along with their 
                                            applications. They are required to 
                                            submit on a white sheet, a 
                                            photograph and finger print of left 
                                            and right index finger, and thumbs 
                                            with their signature at the end of 
                                            the sheet. <br>
                                            <br>
                                            To view the sample letter 
                                            <a href="http://www.udaanindia.com/forms/SAMPLE%20FORMAT%20FOR%20MEXICO.pdf">CLICK HERE
                                            </a>
                                            <br>
                                            <br>
                                            <br>
