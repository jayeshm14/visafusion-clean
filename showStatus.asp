...
//-->
                  ...
                  <td width="19%"> <font size="2" color="#006600"><b><input type="text" name="sentdate" value size="10" readonly>
...
%> 
                ...
                <tr> 
                  ...
                  <td width="80%" colspan="3"> <font size="2" color="#006600"><b> 
                    <%=ucase(rsInvoice.fields("remarks")) %>
                     </b></font></td>
