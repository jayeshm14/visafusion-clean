                                    ...
                                    <div align="justify"> 
                                      ...
                                      <div align="justify"> 
                                        ...
                                        <p> <font size="2" face="Verdana"><b>Dear 
                                          ...
                                          This is to update you on the new visa 
                                          requirement of <font color="#0000FF"><b>Greece 
                                          Embassy</b></font>. <br>
                                          <br>
                                          <b>1.) Hotel confirmation copy (fax 
                                          or scan) on hotel's letterhead. One 
                                          copy to be faxed directly to embassy<br>
                                          2.) Original Bank statement or Photocopy 
                                          of Bank statement attested (bank seal) 
                                          by the bank<br>
                                          3.) In case of Interview. The interview 
                                          will be scheduled on the next working 
                                          day from the day visa application is 
                                          submitted. Incase the passenger does 
                                          not come for an interview then the embassy 
                                          will return back the passports with 
                                          a refusal stamp.</b><br>
                                          <br>
                                          Kindly keep your passenger informed 
                                          about the same. Also note all others 
                                          visa requirements (documents) remain 
                                          the same. <br>
                                          </font><b> </b> </p>
