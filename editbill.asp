...
<input type="hidden" name="invoicedate" value="<%=temp_invoicedate %>">
...
<table width="658" border="0" align="center">
  ...
  <tr bgcolor="#ffffff" border=0> 
    ...
    <td width="255"> 
      <div align="center">DATED. <%= systousrdate(temp_invoicedate) %> </div>
    </td>
  </tr>
  <tr><td colspan="3" align="left"><b>Ref No.</b> <%= refno %></td></tr>
</table>                       
...
stmt ="select b.paxid, b.paxname,a.visafee,a.VFSTTCharges,a.handlingfee,a.ddcharges,a.countryid from invoicedetail a,entrydetails b  where a.paxid=b.paxid and a.invoiceno="&invno& " and a.invtype='B' order by b.paxname"
'response.write stmt
rs.open stmt,con
counter =1
if not rs.eof then
...
'temp_total=rs("total")
temp_total=temp_handlingfee + temp_visafee + temp_VFSTTCharges + temp_ddcharges
...
<table width="658" border="0" align="center">
  ...
  <tr> 
    <td align="center"> 
      ...
      <input type="submit" value=" Back " onclick="history.back()" size="20">
    </td>
  </tr></form>
</table>
     <script language="javascript">
