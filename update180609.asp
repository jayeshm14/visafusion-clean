...
.style56 {font-family: Verdana, Arial, Helvetica, sans-serif; font-weight: bold; }
-->
</style>
</head>
                                  ...
                                  <td width="62%" height="346" bordercolor="#000000"> 
                                    <div align="justify"> 
                                      ...
                                      <div align="justify"> <b>= = = = = = = = 
                                        ...
                                        <div align="center" class="style35 style31 style52">HONG KONG BUSINESS VISA - UPDATE</div>
                                        <span class="style28"><br>
                                        </span>
                                        <p align="justify" class='style45'><strong>Dear Travel Partners;</strong><br>
                                            <br>
                                            <span class="style50">Prior  appointment is required in order to submit the applications for Hong Kong business visa. The Embassy is taking 3-4 days for giving appointment for submission.</span></p>
                                        <p align="justify" class='style19'></p>
                                        <p align="justify" class='style27'><span class="style45"><br>
                                        </span></p>
                                        <p align="justify" class="style56">The Business visa requirements for Hong Kong are:  </p>
                                        <ul class="style54">
                                          <li class="style50"> Passport with validity of more than six months.</li>
                                          <li class="style50"> 1 Visa application form duly filled in and signed-Photocopy can be used.</li>
                                          <li class="style50"> 2 Recent passport size color photographs with white background.</li>
                                          <li class="style50"> Original covering letter on the company's letter head from the applicant duly signed and typed with the company stamp address to - <strong>The Visa Officer, Embassy of China, New Delhi.</strong></li>
                                          <li class="style50"> Invitation from Hong Kong Company with seal &amp; signed.</li>
                                          <li class="style50"> Confirm Air Tickets. <br>
                                              <br>
                                            Indian Nationals can take <strong class="style45">Tourist Visa</strong> on arrival which is valid for 14 days. <br>
                                            <br>
                                          </li>
                                          </ul>
