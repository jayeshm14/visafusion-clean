...
<%
dim service_charge
service_charge= total_handling * 10.3
service_charge=service_charge/100
%>
      <div align="right">Misc. Charges 1: 
        <input type="text" name="miscremark"  size="50" value="Service tax 10.3 % on Handling charges" >
      </div>
    </td>
    <td width="66" > 
...
<script language="javascript">
				...
				var servicetax=tothandling*10.3
				servicetax=servicetax/100
				document.regist.misc.value=Math.round(servicetax)
				}
