...
.style15 {font-family: VRINDA; font-size: 16pt; color: #FFFFFF; }
          ...
          <td> 
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                ...
                <td width="650" height="2" colspan="3"> 
                  <div align="center"><b></b></div>                </td>
              </tr>
              <tr> 
                <td width="21" height="845">&nbsp;</td>
                <td colspan="3" height="845"> 
                  <table height="832" cellspacing="0" cellpadding="0" width="100%" border="0">
                    <tbody> 
                    <tr> 
                      <td colspan="2" height="832"> 
                        <table width="536" align="center" height="832" border="1" bordercolor="#333333">
                          <tr> 
                            <td height="2" colspan="2"><img src="http://www.udaanindia.com/updateimg/back-ground.jpg" width="655" height="6"></td>
                          </tr>
                          <tr valign="top" > 
                            <td height="814" colspan="2"> 
                              <table width="77%" border="1" height="794">
                                <tr bordercolor="#000000" valign="top" bgcolor="#FFFFFF"> 
                                  <td width="62%" height="788" bordercolor="#000000"> 
                                    <div align="justify"> 
                                      ...
                                      <div align="justify"> 
                                        <p align="center"><b>= = = = = = = = = = = = = = = = 
                                          = = = = = = = = = = = = = = = = = = 
                                          = = <br>
                                          &nbsp;</b><span class="style8"> <u>HOLIDAY</u></span></p>
                                        <table border="2" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
                                          <tr>
                                            <td width="100%" bgcolor="#990066"><p align="justify"><span class="style19"><strong><span class="style13">Dear Travel Partners,</span></strong><span class="style13"><br>
                                              Due to General Assembly Elections we will be closed on Thursday 7th May'09. <br>
                                              <br>
                                              In case of Emergency                                           please contact :<br>
                                              <br>
                                              Mr. Harpreet Gulati: <span class="style13">+91-9818201852<br>
                                              Mr. Nirupam Kathuria: 
                                              <span class="style13">+91-9871667666</span><br>
                                              Ms. Pooja Sarin: +9<span class="style13">1-9810063345<br>
                                              Mr. Basudev Bhatt: +91-<span class="style13">9250418961</span></span></span></span></span>
                                            ...
                                            <p align="justify" class="style15">                                            
                                            <p align="justify" class="style15"><span class="style15">Regards<br>
                                              Udaan Team</span></td>
                                          </tr>
                                        </table>
                                      ...
                                      <table width="100%" border="1" height="58">
                                        <tr> 
                                          <td height="52"> 
                                            <div align="center">
                                      ...
                                      <b> </b><img src="http://www.udaanindia.com/updateimg/back-ground.jpg" width="645" height="6"></div>                                  </td>
                                </tr>
                              </table>                            </td>
                          </tr>
                        </table>                      </td>
