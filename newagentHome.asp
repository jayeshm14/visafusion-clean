  ...
  <tr> 
    <td> 
      <table width="75%" align="center" cellpadding="0" cellspacing="0">
        <tr bgcolor="#FFE898"> 
          <td height="19"> 
            <div align="center"><span class="tableCaption">NEW AGENTS INFORMATION</span></div>
          </td>
        </tr>
      </table>
    </td>
                ...
                <td bgcolor="#FFFFFF"> 
                  <table width="100%" border="0" bgcolor="#FFFFF8" cellpadding="0" cellspacing="0" background="images/backform.jpg">
                    <tr> 
                      ...
                      <td width="50%"> <form name="searchform" action="newagenttestsubmit.asp">
                        <div align="left"><span class="WSRightBold"> 
                          <select size=1  name="agent">
                            <%
                                             Call LoadListBox("newagents",agentID)
                                             %> 
                          </select>
                          </span></div>
                      </td>
