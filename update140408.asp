                                    ...
                                    <div align="justify"> 
                                      ...
                                      <div align="justify"> 
                                        ...
                                        <table width="100%">
                                          <tr>
                                            <td height="20"> 
                                              <div align="center"><font size="5" face="Courier New"><b><font size="6">CHINA 
                                                EMBASSY IMPOSES STRINGENT VISA 
                                                REGULATIONS </font></b></font></div>
                                            </td>
                                          </tr>
                                        </table>
                                        <p> <font size="3" face="Courier New">With 
                                          immediate effect the <b>Embassy of China</b> 
                                          has revised requirements of documents 
                                          for obtaining a Visa to china. <b>The 
                                          documents for Tourist & Business Visa 
                                          are as follows:- <br>
                                          </b><br>
                                          <b>Tourist Visa:-</b><br>
                                          <br>
                                          1.) Passport & Fully filled visa forms 
                                          <br>
                                          2.) One photograph <br>
                                          3.) Original covering letter from the 
                                          applicant duly signed & &nbsp;&nbsp;&nbsp;&nbsp;typed 
                                          <br>
                                          4.) Round trip confirmed Air Ticket 
                                          <br>
                                          5.) Confirmed Hotel<br>
                                          6.) Updated Bank statement of the applicant 
                                          with a minimum &nbsp;&nbsp;&nbsp;&nbsp;balance 
                                          of $3000 </font><br>
                                        </p>
                                        <p> <font size="3" face="Courier New"><b>Business 
                                          Visa:-</b><br>
                                          <br>
                                          1.) Passport & Fully filled visa forms 
                                          <br>
                                          ...
                                          applicant duly signed & &nbsp;&nbsp;&nbsp;&nbsp;typed 
                                          <br>
                                          4.) <b>Original Visa Notification Letter</b> 
                                          from the Immigration of &nbsp;&nbsp;&nbsp;&nbsp;China. 
                                          This note will be arranged by the sponsor 
                                          & will act &nbsp;&nbsp;&nbsp;&nbsp;as 
                                          an invite letter.<br>
                                          <br>
                                          Kindly note that granting of Visa is 
                                          on the sole discretion of the embassy. 
                                          Besides the above listed requirements 
                                          the Embassy can ask for any other additional 
                                          documents or ask the applicant to come 
