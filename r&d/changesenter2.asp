...
Set webcon=server.CreateObject ("ADODB.Connection")
webcon.open "driver={SQL server};Server=63.171.211.86;uid=udaanindia;pwd=uda3000;database=udaanindia"
...
rs.open "select refno from changes where refno > '25800' order by refno", con, 3,3
if rs.eof then
