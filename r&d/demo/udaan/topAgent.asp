    ...
    <td height="20"> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFE898">
        <tr>
          ...
          <td> 
            <div align="center"><span class="barfont"><a href="Agent.asp?statustype=sub&logon=Y&anp=34&cd=2345&seckey=xyz25g78md20422npr054416panftphjkslsktls&ses=k3456l7dj9javyemsn&company=udaan&jn=<%=agentID%>" class="udtop">Submitted</a> 
              ...
              Visa Information </a> &nbsp;&nbsp;| <a href="changepasswordforagent.asp?uname=<%=session("uname")%>&&logon=Y&anp=34&cd=2345&seckey=xyz25g78md20422npr054416panftphjkslsktls&ses=k3456l7dj9javyemsn&company=udaan&jn=<%=agentID%>" class="udtop">Change 
              Pasword</a>&nbsp;| <a href="editbyagent.asp?uname=<%=session("uname")%>&&logon=Y&anp=34&cd=2345&seckey=xyz25g78md20422npr054416panftphjkslsktls&ses=k3456l7dj9javyemsn&company=udaan&jn=<%=agentID%>" class="udtop">Update 
