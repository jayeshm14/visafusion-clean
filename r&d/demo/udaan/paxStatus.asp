...
response.write "<tr bgcolor='#ffffe4'><td colspan=7><font size='2' face='Arial' color='#3300CC'><b><a href='collectionFormPax.asp?refno="&refno&"&paxID="&paxID&"&agent="&agent&"&pname="&paxname&"' >"& ucase(paxname)&"</a></b><font size=2 face='arial' color=#C35068> for </font><font size=2 face='arial' color=#C35068><a href='collectionFormPaxCountry.asp?refno="&refno&"&paxID="&paxID&"&agent="&agent&"&country="&country &"&pname="&paxname&"' > "

Call WriteIDDescription("Embassy",country)
response.write "</a></font> </font></td><td><font face='arial' size=2 color='#000000'> Agent: "
call writeIddescription("agents",agent)
response.write "</font></td></tr>"
response.write "<tr bgcolor='#F0F0FF'><td><font face='arial' size=2 color='#000000'>"&refno&"</font></td><td><font face='arial' size=2 color='#000000'>"& recdate &"</font></td><td><font face='arial' size=2 color='#000000'>"& subdate &"</font></td><td><font face='arial' size=2 color='#000000'>"& coldate &"</font></td><td><font face='arial' size=2 color='#000000'>"&rs.fields("totalpax")&"</font></td><td><font face='arial' size=2 color='#000000'><a href='collectionFormPaxCountry.asp?refno="&refno&"&paxID="&paxID&"&agent="&agent&"&country="&country &"&pname="&paxname&"' > "
if status <> "" then
call writeIddescription("status",status)
end if
response.write "</a></font></td><td><font face='arial' size=2 color='#000000'>&nbsp;"& sentdate &"&nbsp;</font></td>"

response.write "<td><font face='arial' size=2 color='#000000'> <a href='emailRefno.asp?refno="&refno&"&paxID="&paxID&"&country="&country&"' >EMAIL</a></font></td></tr>"
...
%>
 ...
 <%
stmtHistory = "select StatusHistory.statusID,StatusHistory.date,StatusHistory.updatedby,StatusHistory.Remarks from StatusHistory where StatusHistory.paxid="&cint(paxid)&" and StatusHistory.countryID="&cint(rs("countryID")) & " Order by Date desc"
