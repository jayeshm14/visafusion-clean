...
<FORM action="newpassword.asp"  method=post name="agentform"  onsubmit="return checkpassword()">
...
border=1  cellPadding=1 cellSpacing=1 width=75% id=TABLE1>
    ...
    <TR>
        ...
        <TD><span class="WSRightBold">
            <INPUT  name="username" value="<%= request("uname")%>" onsubmit="return checkAll()"></FONT></TD></TR>
    <TR>
