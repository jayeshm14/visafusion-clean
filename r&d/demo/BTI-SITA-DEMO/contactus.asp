            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td colspan="2" height="276"> 
                  <table width="100%" border="0">
                    <tr> 
                      ...
                      <td width="99%" height="173"> 
                        <div align="justify"> 
                          <form method="post" action="contactsendpre.asp" name="form1"  >
                            <table width="100%" border="0">
                              <tr> 
                              ...
                              <tr> 
                                ...
                                <td height="2" width="28%"><b><font size="2" face="Arial, Helvetica, sans-serif">NAME 
                                  &amp; DESIGNATION</font></b></td>
                                <td height="2" width="45%"> 
                                  <input type="text" name="name" value="">
                                  <input type="hidden" name="priv" value="AGT">
                                  <input type="hidden" name="uid" value="T.COOK-DEL-CORP">
                                </td>
                              </tr>
                              <tr> 
                                <td height="2" width="27%">&nbsp;</td>
                                <td height="2" width="28%"><b><font size="2" face="Arial, Helvetica, sans-serif">COMPANY 
                                  NAME </font></b></td>
                                <td height="2" width="45%"> 
                                  <input type="text" name="cname" value="THOMAS COOK (INDIA) LTD. (CORPORATE)">
                                </td>
                              </tr>
                              <tr> 
                                <td height="2" width="27%">&nbsp;</td>
                                <td height="2" width="28%"><b><font size="2" face="Arial, Helvetica, sans-serif">PHONE 
                                  </font></b></td>
                                <td height="2" width="45%"> 
                                  <input type="text" name="phone"  value="23416585 / 26468041 (N-PLACE ) ;  9810868997 (ARUN )">
                                </td>
                              </tr>
                              <tr> 
                                <td height="2" width="27%">&nbsp;</td>
                                <td height="2" width="28%"><b><font size="2" face="Arial, Helvetica, sans-serif">FAX</font></b></td>
                                <td height="2" width="45%"> 
                                  <input type="text" name="fax"  value="011-23412241">
                                </td>
                              </tr>
                              <tr> 
                                <td height="2" width="27%">&nbsp;</td>
                                <td height="2" width="28%"><b><font size="2" face="Arial, Helvetica, sans-serif">EMAIL</font></b></td>
                                <td height="2" width="45%"> 
                                  <input type="text" name="email"  value="arun.khanna@in.thomascook.com  ;  neeraj.sarna@in.thomascook.com, ajay.bhatia@in.thomascook.com ; traveltcs@delhi.tcs.co.in">
                                </td>
                              </tr>
                              <tr> 
                                <td height="2" width="27%">&nbsp;</td>
                                <td height="2" width="28%"><b><font size="2" face="Arial, Helvetica, sans-serif">CITY</font></b></td>
                                <td height="2" width="45%"> 
                                  <input type="text" name="city" value="NEW DELHI">
                                </td>
                              </tr>
                              <tr> 
                                <td height="2" width="27%">&nbsp;</td>
                  ...
                  <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2" color="#0000FF">WRITE 
                ...
                <td colspan="2" height="41"> 
                  <table align="center" width="100%">
                    <tr> 
                      ...
                      <td width="33%" valign="top" height="46"><span class="wsrightbold">UDAAN 
                        INDIA PRIVATE LIMITED :</span></td>
                      <td width="59%" height="46"> 
                        <p><span class="website"> # 309 - 312 SOMDUTT CHAMBERS 
                          II,<br>
                          9, BHIKAIJI CAMA PLACE, <br>
                          NEW DELHI 110 066.</span></p>
                      </td>
                    </tr>
                    <tr> 
                      <td width="8%" valign="top">&nbsp; </td>
                      <td width="33%" valign="top"><span class="wsrightbold">CONTACT 
                        US ON :</span></td>
                      <td width="59%"><span class="wsrightbold">PHONES : </span><span class="website">011 
                        - 2616 0840 / 2617 7435 / 2610 3864 <br>
                        2619 6928 / 2618 2402 / 2618 2403.</span></td>
                    </tr>
                    <tr> 
                      <td width="8%"> </td>
                      <td width="33%"></td>
                      <td width="59%"><span class="wsrightbold"> FACSIMILE : </span><span class="website">011 
                        - 2616 0606.</span></td>
                    </tr>
                    <tr> 
                      <td width="8%">&nbsp; </td>
                      <td width="33%">&nbsp;</td>
                      <td width="59%"><span class="wsrightbold">E. MAIL : </span><span class="website"><a href="mailto:udaan@spectranet.com">udaan@spectranet.com 
                        </a></span> </td>
                    </tr>
                    <tr> 
              ...
              <tr> 
                <td colspan="2" height="2"> 
                  <p align="center"><font color="#006633"><b><font face="Arial, Helvetica, sans-serif" size="2" color="#FF0000">TO 
                    ESTABLISH YOUR USER ID / PASSWORD</font><font face="Arial, Helvetica, sans-serif" size="2"> 
