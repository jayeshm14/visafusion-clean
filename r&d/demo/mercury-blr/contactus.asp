                  ...
                  <table width="100%" border="0">
                    <tr> 
                      ...
                      <td width="99%" height="173"> 
                        <div align="justify"> 
                          <form method="post" action="contactsend.asp" name="form1"  >
                            <table width="100%" border="0">
                              <tr> 
                              ...
                              <tr> 
                                ...
                                <td height="2" width="28%"><b><font size="2" face="Arial, Helvetica, sans-serif">COMPANY 
                                  NAME </font></b></td>
                                <td height="2" width="45%"> 
                                  <input type="text" name="cname" value="MERCURY TRAVELS LTD">
                                </td>
                              </tr>
                              <tr> 
                                <td height="2" width="27%">&nbsp;</td>
                                ...
                                <td height="2" width="45%"> 
                                  <input type="text" name="phone"  value="080 - 5591222, 5591641 TO 5591645 - RAJESH MOBILE : 9886030891">
                                </td>
                              </tr>
                              <tr> 
                                <td height="2" width="27%">&nbsp;</td>
                                ...
                                <td height="2" width="45%"> 
                                  <input type="text" name="fax"  value="080 - 5591505">
                                </td>
                              </tr>
                              <tr> 
                                <td height="2" width="27%">&nbsp;</td>
                                ...
                                <td height="2" width="45%"> 
                                  <input type="text" name="email"  value="rmehta@mercury-india0.com, RNSHREE@mercury_india.com">
                                </td>
                              </tr>
                              <tr> 
                                <td height="2" width="27%">&nbsp;</td>
