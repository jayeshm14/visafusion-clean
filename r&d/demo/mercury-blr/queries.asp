                            ...
                            <tr> 
                              ...
                              <td><span class="WSRightBold"> 
                                <select size="1" name="countrylist">
                                  ...
                                  <option value=227>ANTIGUA & BARBUDA</option>
                                  <option value=20>ARGENTINA</option>
                                  <option value=113>ARMENIA</option>
                                  <option value=228>ARUBA</option>
                                  ...
                                  <option value=232>BOTSWANA</option>
                                  <option value=25>BRAZIL</option>
                                  <option value=26>BRUNEI DARUSSALAM</option>
                                  <option value=27>BULGARIA</option>
                                  <option value=28>BURKINA FASO</option>
                                  <option value=233>BURUNDI</option>
                                  <option value=29>CAMBODIA</option>
                                  <option value=234>CAMEROON</option>
                                  <option value=2>CANADA</option>
                                  <option value=235>CAPE VERDE ISLANDS</option>
                                  <option value=236>CAYMAN ISLANDS</option>
                                  <option value=237>CENTRAL AFRICAN REPUBLIC</option>
                                  <option value=238>CHAD</option>
                                  <option value=7>CHILE</option>
                                  <option value=30>CHINA</option>
                                  <option value=239>CHINESE TAIPEI</option>
                                  ...
                                  <option value=260>COTE D IVOIRE</option>
                                  ...
                                  <option value=241>DOMINICA COMMOWEALTH</option>
                                  <option value=242>DOMINICAN REPUBLIC</option>
                                  <option value=300>EAST TIMOR</option>
                                  ...
                                  <option value=244>EQUATORIAL GUINEA</option>
                                  <option value=120>ERITREA</option>
                                  <option value=39>ESTONIA</option>
                                  <option value=40>ETHIOPIA</option>
                                  <option value=247>FALKLAND ISLANDS</option>
                                  <option value=245>FIJI</option>
                                  <option value=41>FINLAND</option>
                                  <option value=42>FRANCE</option>
                                  <option value=246>FRENCH GUIANA</option>
                                  <option value=249>FRENCH POLYNESIA</option>
                                  <option value=248>FRENCH WEST INDIES</option>
                                  <option value=250>FYROM</option>
                                  ...
                                  <option value=252>GUAM</option>
                                  <option value=253>GUATEMALA</option>
                                  <option value=123>GUINEA</option>
                                  <option value=255>GUINEA-BISSAU</option>
                                  <option value=254>GUYANA</option>
                                  <option value=257>HAITI</option>
                                  <option value=258>HAWAIIAN ISLANDS</option>
                                  <option value=124>HOLY SEE</option>
                                  <option value=259>HONDURAS</option>
                                  ...
                                  <option value=261>JOHNSTON ISLANDS</option>
                                  <option value=53>JORDAN</option>
                                  <option value=54>KAZAKSTAN</option>
                                  <option value=55>KENYA</option>
                                  <option value=262>KIRIBATI</option>
                                  <option value=9>KOREA - D.P.R (N/KOREA)</option>
                                  <option value=126>KOREA - REP. OF (S/KOREA)</option>
                                  <option value=107>KUWAIT</option>
                                  <option value=57>KYRGYZSTAN</option>
                                  <option value=58>LAOS</option>
                                  <option value=186>LATVIA</option>
                                  <option value=59>LEBANON</option>
                                  <option value=264>LEEWARD ISLANDS</option>
                                  <option value=127>LESOTHO</option>
                                  <option value=263>LIBERIA</option>
                                  <option value=60>LIBYA</option>
                                  <option value=265>LIECHTENSTEIN</option>
                                  ...
                                  <option value=275>NETHERLANDS ANTILLES</option>
                                  ...
                                  <option value=274>NORFOLK ISLANDS</option>
                                  ...
                                  <option value=279>PALAU ISLANDS</option>
                                  ...
                                  <option value=278>PUERTO RICO</option>
                                  <option value=137>QATAR</option>
                                  <option value=280>REUNION</option>
                                  <option value=77>ROMANIA</option>
                                  <option value=78>RUSSIAN FEDERATION</option>
                                  <option value=138>RWANDA</option>
                                  <option value=289>SAMOA - AMERICAN</option>
                                  <option value=290>SAMOA - WESTERN</option>
                                  <option value=193>SAN MARINO</option>
                                  <option value=282>SAO TOME & PRINCIPE</option>
                                  <option value=80>SAUDI ARABIA</option>
                                  <option value=81>SENEGAL</option>
                                  <option value=139>SEYCHELLES</option>
                                  <option value=283>SIERRA LEONE</option>
                                  <option value=82>SINGAPORE</option>
                                  <option value=83>SLOVAKIA</option>
                                  <option value=284>SLOVENIA</option>
                                  <option value=285>SOLOMON ISLANDS</option>
                                  <option value=140>SOMALIA</option>
                                  <option value=79>SOUTH AFRICA</option>
                                  <option value=84>SPAIN</option>
                                  <option value=85>SRILANKA</option>
                                  <option value=286>ST. KITTS & NEVIS</option>
                                  <option value=287>ST. LUCIA</option>
                                  <option value=288>ST. VINCENT & GERANDINES</option>
                                  <option value=86>SUDAN</option>
                                  <option value=141>SURINAME</option>
                                  <option value=291>SWAINS ISLANDS</option>
                                  ...
                                  <option value=292>TONGO</option>
                                  <option value=295>TRANSKEI</option>
                                  ...
                                  <option value=293>TURKS & CAICOS ISLANDS</option>
                                  <option value=294>TUVALU</option>
                                  <option value=145>U.A.E - ATTESTIONS</option>
                                  ...
                                  <option value=296>VANATU</option>
                                  <option value=108>VATICAN CITY</option>
                                  <option value=101>VENEZUELA</option>
                                  <option value=102>VIETNAM</option>
                                  <option value=297>VIRGIN ISLANDS</option>
                                  <option value=298>WAKE ISLANDS</option>
                                  <option value=299>WINWARD ISLANDS</option>
                            ...
                            <tr> 
                              <td align="center" colspan="2"><span class="WSRightBold"> 
                                ...
                                <p align="left"><span class="WSRightBold">FOR 
                                  ...
                                  <a href="contactus.asp">UDAAN</a> &quot;</b></font></span></p>
                              </td>
                            </tr>
                          </table>
                        </form>
