                                    ...
                                    <div align="justify"> 
                                      ...
                                      <div align="justify"> 
                                        ...
                                        <table width="100%">
                                          <tr>
                                            <td height="20"> 
                                              <div align="center"><font size="5" face="Courier New"><b><font size="6">Submission 
                                                of Cases for Singapore</font> 
                                                </b></font></div>
                                            </td>
                                          </tr>
                                        </table>
                                        <p> <font size="3" face="Courier New">Due 
                                          to certain constraints we have decided 
                                          to submit cases for Singapore of only 
                                          those whose applications have been received 
                                          by <b>2000 hrs daily.</b><br>
                                          <br>
                                          Further these applications must be complete 
                                          in all respects. Only then we will submit 
                                          the applications. The application must 
                                          be signed and completed in all respects 
                                          to save time and minimise the Submission 
                                          time. <br>
                                          <br>
                                          <b>Please ensure the photograph is as 
                                          per specification laid down</b><br>
                                          <br>
                                          1.) 2-coloured recent <b>Camera clicked 
                                          white background</b> passport sized 
                                          photographs on semi matt paper <b>(35 
                                          mm width x 45 mm height) without border.</b><br>
                                          <br>
                                          2.) Full face should come in the photographs 
                                          ...
                                          <br>
                                          3.) The facial image should be between 
                                          <b>25 mm and 35 mm from chin to crown, 
                                          taken against a plain white background 
                                          with matt or semi -matt finish. </b><br>
                                          <br>
                                          <font color="#0000FF"><b>Please help 
                                          us to serve you better by your following 
                                          the above request. </b></font></font><br>
                                        </p>
