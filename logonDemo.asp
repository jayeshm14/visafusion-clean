    ...
    <td> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr> 
                      <td width="1%" height="46"><img src="images/pixel.gif" width="33" height="13"></td>
                      <td width="99%" height="46"><span class="WSRightBold"> 
                        <div align="justify"><span class="WSRightBold">This is the demo user 
created for you so that you could know what is in there for you. 
Click on the LOGON button to enter the UDAAN's personalized website for the customers.</span> </div>
                        </span></td>
                    </tr>
                              ...
                              <table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#FFF3CA">
                                <form method="post" action="authenticate.asp" name="form1">
                                  <tr> 
                                    ...
                                    <td width="65%"> 
                                      <input type="text" value="udaan" name="username">
                                    </td>
                                  </tr>
                                  <tr> 
                                    <td width="34%"> 
                                    ...
                                    <td width="1%"><b><font face="Arial, Helvetica, sans-serif" size="2">:</font></b></td>
                                    <td width="65%"> 
                                      <input type="password" value="udaanindia" name="pass">
                                    </td>
                                  </tr>
                                  <tr> 
                                    <td colspan="3"> 
                ...
                <td width="52%" height="154"> 
                  <div align="center"><img src="images/world.jpg" width="356" height="228"></div>
                </td>
              </tr>
              <tr bgcolor="#FFCCCC"> 
                <td width="100%" colspan="2"> 
                  <div align="left"><marquee><font face="arial" color="red" size="2"><b> 
                    <a href="update.asp"><font color="#FF3366" face="Garamond">UPDATE 
                    20th DECEMBER, 2004</font><font color="#FF0033"> &gt;&gt;&gt; 
                    </font></a></b></font><font size="2"><a href="update.asp"><font face="Arial"><b><font face="Arial"><b><font face="Garamond">NEW 
                    ADDRESS OF THE VENEZUELA EMBASSY..&gt;&gt;&gt;&gt; </font></b></font></b></font></a><b><font color="#FF3333">THE 
                    "EMBASSY OF THE BOLIVARIAN REPUBLIC OF VENEZUELA" - NEW DELHI</font> 
                    WILL REMAIN CLOSED FOR 5 DAYS, STARTING FROM DECEMBER 06, 
                    2004 UPTILL DECEMBER 12, 2004 DUE TO RE-ALLOCATION OF THEIR 
                    OFFICE FROM PANCHSHEEL PARK TO NEW THEIR NEW PREMISES AT "E 
                    - 106, MALCHA MARG, CHANAKYAPURI, NEW DELHI - 110021" WHICH 
                    WILL COME INTO EFFECT FROM DECEMBER 13, 2004.</b></font></marquee></div>
                </td>
              </tr>
            </table>
          </td>
