                            ...
                            <table width="100%" border="0">
                              ...
                              <tr> 
                                ...
                                <td height="2" width="28%"><b><font size="2" face="Verdana" color="#FF0033">COMPANY 
                                  NAME :</font></b></td>
                                <td height="2" width="45%"> 
                                  <input type="text" name="cname" value="<%=cname%>" size="20">
                                </td>
                              </tr>
                              <tr> 
                                <td height="2" width="27%">&nbsp;</td>
                                ...
                                <td height="2" width="45%"> 
                                  <input type="text" name="phone" <% if priv="" then %>onBlur="return numvalid(this)"<%end if%> value="<%=phone%>" size="20">
                                </td>
                              </tr>
                              <tr> 
                                <td height="2" width="27%">&nbsp;</td>
                                <td height="2" width="28%"><b><font size="2" face="Verdana" color="#FF0033">FAX 
                                  : </font></b></td>
                                <td height="2" width="45%"> 
                                  <input type="text" name="fax" <% if priv="" then %>onBlur="return numvalid(this)"<%end if%> value="<%=fax%>" size="20">
                                </td>
                              </tr>
                              <tr> 
                                <td height="2" width="27%">&nbsp;</td>
                                <td height="2" width="28%"><b><font size="2" face="Verdana" color="#FF0033">EMAIL 
                                  : </font></b></td>
                                <td height="2" width="45%"> 
                                  <input type="text" name="email" <% if priv="" then %>onChange="return mail()"<%end if%> value="<%=email%>" size="20">
                                </td>
                              </tr>
                              <tr> 
                                <td height="2" width="27%">&nbsp;</td>
                  ...
                  <table align="center" width="100%">
                    ...
                    <tr> 
                      ...
                      <td width="59%"><span class="wsrightbold"><font face="Verdana" size="2" color="#FF0000">PHONES 
                        ...
                        </font></span><span class="website"><font face="Verdana" size="2">
                      011 - 46700600/2616 0840 / 2617 7435/32592440 .</font></span></td>
                    </tr>
                    <tr> 
                      <td width="8%"> </td>
                      <td width="33%"></td>
