...
.style44 {font-size: 24px; color: #0000FF; font-family: "Times New Roman", Times, serif; }
-->
</style>
</head>
                                  ...
                                  <td width="62%" height="346" bordercolor="#000000"> 
                                    <div align="justify"> 
                                      ...
                                      <div align="justify"> <b>= = = = = = = = 
                                        ...
                                        <table width="709" height="137" border="0">
  <tr bgcolor="#9999CC">
    <th height="49" bgcolor="#FFFFFF" scope="col"><h2><strong class="style8">SOUTH AFRICA UPDATE</strong></h2></th>
  </tr>
  <tr bgcolor="#9999CC">
    <th height="82" bgcolor="#FFFFFF" scope="col"><div align="justify">
      <p><font face='Verdana, Arial, Helvetica, sans-serif'><span class="style42"><span class="style19">Dear Travel Partners<strong class="style8">,</strong></span></span></font><font size='4' face='Verdana, Arial, Helvetica, sans-serif' color='#FFFFFF'>ese</font></p>
      <p class="style42"><span class="style46">WEF 16th Nov'09  &quot;Power of Attorney&quot; form has to be filled by all the applicants applying for</span><span class="style46"> South Africa Visa for all the categories (i.e. Business, Tourist, and Work). </span></p>
      <p class="style42"><span class="style46">To download  Power Of Attorney form logon to our website: <span class="style71">www.udaanindia.com</span> or click on the link below.</span></p>
      <p class="style42"><a href="http://udaanindia.com/forms/SA-powerofattorney.pdf" class="style44">Power Of Attorney Form</a></p>
      <p class="style42">&nbsp;</p>
      <p class="style46"><strong>Regards<br>
Udaan Team</strong></p>
    </div></th>
  </tr>
</table><br>
