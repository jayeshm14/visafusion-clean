...
<% else %>
</form><form method="post" action="visaInfoSubmit.asp?statustype=sub&logon=Y&anp=34&cd=2345&seckey=xyz25g78md20422npr054416panftphjkslsktls&ses=k3456l7dj9javyemsn&company=udaan&jn=<%=agentID%>" name="queries"> 
<% end if %>
<% if request("agentusb")="yesuma" then %>
...
<div align="center"><table width="69%" border="0" height="82"></div>
	<tr>
  <td height="86"> 
      <div align="center"><img src="updateimg/Passports%20and%20visa%20req.jpg" width="476" height="85"></div>
    </td>
  </tr>
</table>
  ...
  <tr> 
    <td  align="center" valign="top" colspan="2"> 
      <table width="115%" border="0" cellspacing="1" cellpadding="1">
          ...
          <tr> 
            <td width="43%" valign="top" align="center"><FONT color=red face="verdana" size="2"><b>COUNTRY:</font></b> 
            ...
            <td width="57%" valign="top"><FONT color=red face="verdana" size="2"><b>CATEGORY:</font></b> 
...
<%
          ...
          <tr> 
            ...
            <% if ucase(session("uname"))="UMA" or ucase(session("su"))="Y" then
%> 
              <div align="right"> 
