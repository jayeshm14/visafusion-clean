...
</table></form><tr><td align="center"><span class="WebSite">
              <%
              
              if request("agent")<> "" and request("flag")=1 then
              response.write "agent "& ucase(request("agent"))&" Added "
              elseif request("agent")<> "" and request("flag")=2 then
