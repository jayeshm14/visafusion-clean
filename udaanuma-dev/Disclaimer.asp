  ...
  <tr>
    <td height="419" align="center"> 
      ...
      src="images/bar_red.gif" width=746></TD>
        ...
        <TR>
          <TD align=left vAlign=top background="images/bigtablebg.gif" height="225"> 
            <table width="743" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr> 
                <td width="523" height="33">&nbsp;</td>
              </tr>
              <tr> 
                <td width="523" height="400" valign="top">
                  <table width="741" border="0" cellpadding="0" cellspacing="0" class="tdborder" align="center">
                    <tr> 
                      <td height="21" background="images/yellowbgband.gif">
                        <p class="lbltext">Disclaimer</p>
                      </td>
                    </tr>
                    <tr> 
                      <td height="328" valign="top" bgcolor="BD402C"> 
                        <p class="visaparagraph"><br>
                        </p>
                        <p class="visaparagraph">&nbsp;</p>
                        <p class="visaparagraph">&nbsp;</p>
                        <p class="visaparagraph">The content and layout of the 
                          site<a href="http://%20www.udaanindia.com"><font color="#FFFFCC"> 
                          www.udaanindia.com</font></a> is the sole property of 
                          Udaan India Pvt Ltd. Any reproduction in whole or in 
                          part in any from whatsoever is strictly prohibited. 
                          Udaan reserves the right to make changes on the website 
                          without prior notification to the agents/customers. 
                          All efforts have been made to ensure correctness of 
                          information on our site however, Udaan India Pvt Ltd 
                          will not be responsible for any error.</p>
                        </td>
                    </tr>
                  </table>
                </td>
        ...
        <TR>
          <TD width="780" height="5" align=center vAlign=top background="images/bigtablebg.gif"><img src="images/bar_red.gif" width="744" height="5"></TD>
        </TR>
        <TR>
          <TD align=left vAlign=top background="images/bigtablebg.gif" height="2">
