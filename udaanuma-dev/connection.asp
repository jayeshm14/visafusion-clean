...
con.open "DRIVER={SQL Server};Server=67.228.120.48;uid=udaanindia;pwd=umHGn3549K;database=udaanindia"
...
Display=Display& " <font color='yellow'>" &SysToUsrDate(FormatdateTime(rs("holiday"),2))&" - </font>"
end if
