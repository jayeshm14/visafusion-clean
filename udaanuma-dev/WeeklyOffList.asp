...
<table width=780 border=0 align=center cellpadding=0 cellspacing=0><tr> 
    <td align=left valign=top background="images/bigtablebg.gif"> 
          ...
          <table width="80%" border="0" cellpadding="1" cellspacing="1" align="center" bgcolor="BD402C">
            <tr>
													<td>
														
                <table width="650" align="center" cellpadding="0" cellspacing="0">
                  <tr bgcolor="#FFE898">
																<td height="21" background="images/yellowbgband.gif" align="center"> <p class="lbltext">WEEKLY 
																				OFF LIST </p>
																</td>
															</tr>
														</table>
            ...
            <tr> 
              <td> 
                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                  <tr> 
                    <td align="center" width="1"><img src="images/pixelsline.gif" width="1" height="7"></td>
                    <td> 
                      <table width="660" border="0" cellpadding="0" cellspacing="0" background="images/backform.jpg">
                        <tr> 
                          <td> 
                            <table width="650" border="0" align="CENTER" cellpadding="1" cellspacing="1">
                              <tr bgcolor="#FBBD06"> 
                                ...
                                <td>
                                  <p class="dynamicheadingagent">Date</p>
                                </td>
                                <td>
                                  <p class="dynamicheadingagent">Reason</p>
                                </td>
                              </tr>
                              <%
          ...
          stmt=stmt&" order by embassy.description, WeeklyOff.weekend"
            ...
            rs.open stmt,con,2,3
                  IF not rs.eof then
                  while not  rs.eof
                              response.write"<tr><td><p class='dynamictext1'>"& rs("description")
                              response.write"</p></td><td><p class='dynamictext1'>"& rs("weekend")
		                        response.write"</p></td><td><p class='dynamictext1'>"&  rs("reason")
		        ...
		        response.write"<tr><td colspan =3 align=center><font face='Verdana, Arial, Helvetica, sans-serif' color='#FFFFFF' size='2'>NO HOLIDAYS FOR THIS MONTH</font></TD></TR>" 
		        end if
		
      
                  rs.close
%> 
                              <form name="holiday" action="WeeklyOffList.asp"><p class='dynamictext1'>
                                <select name="countryID" size="1" ID="Select1" class="dropdown">
	              	...
	              	%> 
                                ...
                                <a href="WeeklyOffList.asp?OrdByDay=Y&countryID=<%=request("countryID")%>&logon=Y&anp=34&cd=2345&seckey=xyz25g78md20422npr054416panftphjkslsktls&jn=<%=agentID%>&ses=k3456l7dj9javyemsn&company=udaan"> 
                                Order By Week Day</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                <a href="HolidayList.asp?logon=Y&anp=34&cd=2345&seckey=xyz25g78md20422npr054416panftphjkslsktls&jn=<%=agentID%>&ses=k3456l7dj9javyemsn&company=udaan"> Holiday List </a> </p>
                              </form>
                            </table>
                          </td>
                        </tr>
