...
<table width="700" border="0" cellpadding="0" cellspacing="0" class="tdborder" align="center">
  <tr> 
    <td height="21" background="images/yellowbgband.gif">
      <p class="lbltext">Submitted</p>
    </td>
  </tr>
  <tr> 
    <td height="30" bgcolor="BD402C">
      <table width="458" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr> 
          <td width="49">
            <p>Name</p>
          </td>
          <td width="141"> 
            <input type="text " name="keywords2" value="<%=request("keywords")%>" size=15 class="dropdown">
          </td>
          <td width="71">
            <p>Country</p>
          </td>
          ...
          <td width="58">
            <input type="image" name="imageField2" src="images/bt_go.gif">
          </td>
        </tr>
      </table>
    </td>
  ...
  <tr> 
    <td height="20" valign="top" bgcolor="BD402C">
      <table width="700" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td height="25" bgcolor="#B21E0D">
            <p class="dynamictextagent">Click PAX Name to Know Visa Case History 
            </p>
          </td>
        </tr>
      </table>
            ...
            <table width="650" height="53" border="0" align="center" cellpadding="0" cellspacing="1">
              <tr> 
                ...
                <td width="150" align="left" bgcolor="#FBBD06">
                  <p class="dynamicheadingagent">Agent Name</p>
                </td>
...
response.write "<tr><td width='70' height='25' colspan=11 align='right' bgcolor='BD402C'><font face='arial' size=2 color='#ff0000'>PLEASE LOG IN AGAIN</font></td></tr>" 
end if

rs.close()
%>
              <tr> 
                <td width="70" height="25" align="right" bgcolor="BD402C">
                  <p class="dynamictext1">dummy</p>
                </td>
                <td width="120" height="25" align="left" bgcolor="BD402C">
                  <p class="dynamictext1">dummy</p>
                </td>
                <td width="150" height="25" align="left" bgcolor="BD402C">
                  <p class="dynamictext1">dummy</p>
                </td>
                <td width="60" height="25" align="left" bgcolor="BD402C">
                  <p class="dynamictext1">dummy</p>
                </td>
                <td width="70" height="25" align="left" bgcolor="BD402C">
                  <p class="dynamictext1">dummy</p>
                </td>
                <td width="70" height="25" align="left" bgcolor="BD402C">
                  <p class="dynamictext1">dummy</p>
                ...
                <td width="60" align="left" bgcolor="BD402C">
                  <p class="dynamictext1">dummy</p>
                </td>
                <td width="70" align="left" bgcolor="BD402C">
                  <p class="dynamictext1">dummy</p>
                </td>
              </tr>
            </table>
